...
android {
    namespace = "com.fridge.fridge_mobil"
    ...
    compileOptions {
        ...
        // yoksa checkDebugAarMetadata "requires core library desugaring to
        // be enabled" hatasıyla patlar (bkz. .wolf/cerebrum.md 2026-08-20).
    ...
    defaultConfig {
        ...
        applicationId = "com.fridge.fridge_mobil"
